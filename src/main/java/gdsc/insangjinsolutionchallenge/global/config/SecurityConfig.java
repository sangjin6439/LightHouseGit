...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.csrf()
                ...
                .requestMatchers("/everlearning/**","https://light-house-web-pt.vercel.app","https://light-house-web-pt.vercel.app/posts/find/list/all","/","/auth/**","/ExtraLogin/**","/swagger-ui.html", "/swagger-ui/**", "/api-docs/**").permitAll()
